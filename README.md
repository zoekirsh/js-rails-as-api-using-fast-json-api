...
> **ASIDE**: Serializers generated by the Fast JSON API gem have two methods called
> `serializable_hash` and `serialized_json` which return a serialized hash and a
